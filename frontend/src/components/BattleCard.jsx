...
const BattleCard = ({ battle }) => {
    ...
    return (
        <Card key={battle._id} className="bg-primary/80 border border-secondary text-white cursor-pointer hover:shadow-lg transition-shadow duration-200"
        ...
        >
            ...
            <CardContent>
                <div className="flex items-center justify-between gap-2 md:gap-6">
                    {/* Rapper 1 */}
                    <div className={`flex flex-col items-center flex-1 ${leading === 'r1' ? 'bg-secondary/30 rounded-lg p-2' : ''}`}>
                    ...
                    {/* Rapper 2 */}
                    <div className={`flex flex-col items-center flex-1 ${leading === 'r2' ? 'bg-secondary/30 rounded-lg p-2' : ''}`}>
                        <Avatar className="w-16 h-16 mb-2">
