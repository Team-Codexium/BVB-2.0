...
const rapperSchema = new mongoose.Schema(
  {
    ...
    tier: {
      type: String,
      enum: ["Gold", "Silver", "Platinum", "Diamond", "Crown", "Ace"],
      default: "Silver",
    },
  },
  {
